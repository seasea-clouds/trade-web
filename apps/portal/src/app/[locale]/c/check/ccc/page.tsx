...
import CccCheckClient from './check-client';
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const title = t('cccMetaTitle') || 'CCC Check | SinoTrade Compliance';
  const description = t('cccMetaDescription') || 'Free compliance check for China import requirements.';
  const path = '/c/check/ccc/';
