...
export default function MarketIntel({ result }: { result: any }) {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6">
      <SectionTitle icon={'📈'} label={t("sectionMarketIntelligence")} />
      <p className="text-sm text-gray-700 mb-4">{mi.chinaImportTrend}</p>
      {mi.keyDrivers?.length > 0 && (
        <div className="mb-3">
          <p className="text-xs font-semibold text-gray-500 uppercase mb-1">{t("labelKeyDrivers")}</p>
      ...
      {mi.barriers?.length > 0 && (
        <div className="mb-3">
          <p className="text-xs font-semibold text-gray-500 uppercase mb-1">{t("labelBarriers")}</p>
      ...
      {mi.topOrigins?.length > 0 && (
        <div className="mb-3">
          <p className="text-xs font-semibold text-gray-500 uppercase mb-1">{t("labelTopCompetingOrigins")}</p>
      ...
      {mi.recommendation && (
        <div className="mt-4 bg-gold/5 rounded-lg p-3 border border-gold/20">
          <p className="text-xs text-gray-500 mb-1">{t("labelRecommendation")}</p>
