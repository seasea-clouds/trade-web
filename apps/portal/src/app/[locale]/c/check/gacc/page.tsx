...
import GaccCheckClient from './check-client';
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const title = t('gaccMetaTitle') || 'GACC Check | SinoTrade Compliance';
  const description = t('gaccMetaDescription') || 'Free compliance check for China import requirements.';
  const path = '/c/check/gacc/';
